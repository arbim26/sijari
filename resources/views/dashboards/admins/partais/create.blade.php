      ...
      <div class="card-body">
        <form action="{{ route('partai.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control @error('nama_partai') is-invalid @enderror" name="nama_partai" placeholder="Masukkan Nama Partai" />
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control @error('ketua_partai') is-invalid @enderror" name="ketua_partai" placeholder="Masukkan Ketua Partai" />
          ...
          <div class="mb-3">
            ...
            <div class="input-group input-group-merge">
              <input type="file" id="basic-default-email" class="form-control @error('image') is-invalid @enderror" name="image" placeholder="john.doe" aria-label="john.doe" aria-describedby="basic-default-email2" />
